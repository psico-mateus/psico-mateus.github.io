...
export default function PrivacyPage() {
  return (
    <main className="dashboard privacy-page" id="conteudo" tabIndex={-1}>
      ...
      <p className="lead">Versão de 20 de agosto de 2026.</p>
      <section className="panel stack">
        ...
        <p>
          ...
          que você escrever, as revisões opcionais que salvar junto deles e o
          conteúdo que decidir guardar no “Meu mapa”. O e-mail não é armazenado
          em texto legível.
        </p>
        ...
        <h2>Revisão de um pensamento</h2>
        <p>
          Você pode salvar uma revisão opcional junto de um registro. Ela segue a
          mesma privacidade do registro: continua privada enquanto ele estiver
          privado e fica visível para Mateus apenas quando o registro estiver
          compartilhado. Retirar o compartilhamento interrompe o acesso ao registro
          e à revisão. Excluir o registro também exclui a revisão anexada. O texto
          original do registro não é substituído.
        </p>
        <h2>Meu mapa</h2>
        <p>
        ...
        <p>
          ...
          da conta, dos registros e das revisões anexadas, do rascunho completo do
          “Meu mapa” e das partes do mapa que estiverem compartilhadas. Ela também
          informa quando Mateus marcou
